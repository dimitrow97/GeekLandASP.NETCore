        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specs = table.Column<string>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductBuyer", x => new { x.BuyerId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductBuyer_AspNetUsers_BuyerId1",
                        column: x => x.BuyerId1,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductBuyer_BuyerId1",
                table: "ProductBuyer",
                column: "BuyerId1");

            migrationBuilder.CreateIndex(
                name: "IX_ProductBuyer_ProductId",
                table: "ProductBuyer",
                column: "ProductId");
